...
void outScre(ofstream, Upper,int &,int &,int &,int &,int &,int &);
...
int main(int argc, char** argv) {
    ...
    unsigned short totscore=0;      //Total score
    char rollAgn;               //y/n to roll again
    unsigned short numdice=5;
    int die[numdice];           //Array of dice
    
    //Structure variable
    Upper score;               //Section of upper score 
    
    
    //File objects
    ofstream outFile("score.txt",ios::in);
    ifstream inFile;
...
//Output Score
void outScre(ofstream outFile, Upper &type,int &score1,int &score2,int &score3,int &score4,int &score5,int &score6){
    type.ace=score1;
    outFile<<type.ace<<endl;
}
/***********************************************************************
                Print Score Card
 * *********************************************************************
 ...
 //Declare variables
    ...
    unsigned short three=3;
            ...
            for(int i=0;i<numdice;i++){         //Loop for all dice
                    ...
                    if(value==die[i+1]){        //Increment match counter if there is a match
                        match+=1;
                    }
            }
            //Score 3 of a kind
...
/***********************************************************************
                            Roll Dice (POINTER NOTATION USED HERE)
 * *********************************************************************
 * Input:
